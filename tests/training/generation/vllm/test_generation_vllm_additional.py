...
import maxent_grpo.training.generation.vllm as vllm
from maxent_grpo.training.generation import vllm_distributed, vllm_requests
...
def test_prompt_char_limit_falls_back_on_import_error(monkeypatch):
    ...
    def _boom(name, *args, **kwargs):
        if name == "maxent_grpo.training.generation.vllm":
...
def test_current_torch_prefers_global_when_no_vllm_module(monkeypatch):
    monkeypatch.setitem(
        vllm_distributed.sys.modules, "maxent_grpo.training.generation.vllm", None
    )
