...
def test_oat_upstream_explorer_wrappers_reuse_readme_flash_runtime() -> None:
    ...
    assert 'OAT_ZERO_MAXENT_CLIP_PRESERVE_REWARD_MASS="${OAT_ZERO_MAXENT_CLIP_PRESERVE_REWARD_MASS:-1}"' in run_script
    ...
    assert 'OAT_ZERO_MAXENT_SEQUENCE_AUX_COEF="${OAT_ZERO_MAXENT_SEQUENCE_AUX_COEF:-0.1}"' in run_script
