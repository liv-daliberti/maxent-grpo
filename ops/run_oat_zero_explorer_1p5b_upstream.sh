...
export OAT_ZERO_MAXENT_COMPETITIVE_MODE_TOP_K="${OAT_ZERO_MAXENT_COMPETITIVE_MODE_TOP_K:-6}"
...
export OAT_ZERO_MAXENT_VERIFIED_DISTINCT_BONUS_COEF="${OAT_ZERO_MAXENT_VERIFIED_DISTINCT_BONUS_COEF:-0.0}"
