...
PROTOCOL="$ROOT_DIR/paper/preregistration/e47r_reasoned_math_strategy_calibration.md"
ENDPOINT="$ROOT_DIR/var/artifacts/e49_math_strategy_qwen72_v1/qwen72_endpoint.json"
OUTPUT="$ROOT_DIR/var/artifacts/e47r_reasoned_math_strategy_calibration_v1"
LOG="$ROOT_DIR/var/artifacts/e47r_reasoned_math_strategy_calibration_v1.log"
...
if [[ ! -x "$PYTHON_BIN" ]] \
  ...
  echo "E47R frozen prerequisite is missing" >&2
  exit 2
fi
...
echo "=== E47R frozen reasoned proof/equivalence calibration ==="
...
echo "=== E47R automatic calibration complete; blinded audit ready ==="
