#!/usr/bin/env bash
# Resume-safe execution of the frozen E47L calibration.
set -euo pipefail

ROOT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/../.." && pwd)"
PYTHON_BIN="$ROOT_DIR/var/seed_paper_eval/paper310/bin/python"
PIPELINE="$ROOT_DIR/ops/math_strategy_calibration/e47b_bounded_calibration.py"
PROTOCOL="$ROOT_DIR/paper/preregistration/e47l_two_stage_math_strategy_calibration.md"
ENDPOINT="$ROOT_DIR/var/artifacts/e49_math_strategy_qwen72_v1/qwen72_endpoint.json"
OUTPUT="$ROOT_DIR/var/artifacts/e47l_two_stage_math_strategy_calibration_v1"
LOG="$ROOT_DIR/var/artifacts/e47l_two_stage_math_strategy_calibration_v1.log"
...
if [[ ! -x "$PYTHON_BIN" ]] \
  ...
  echo "E47L frozen prerequisite is missing" >&2
  exit 2
fi
...
echo "=== E47L frozen two-stage integrity calibration ==="
...
echo "=== E47L automatic calibration complete; blinded audit ready ==="
