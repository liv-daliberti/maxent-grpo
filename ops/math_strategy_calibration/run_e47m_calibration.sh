#!/usr/bin/env bash
# Resume-safe execution of the frozen E47M calibration.
set -euo pipefail

ROOT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/../.." && pwd)"
PYTHON_BIN="$ROOT_DIR/var/seed_paper_eval/paper310/bin/python"
PIPELINE="$ROOT_DIR/ops/math_strategy_calibration/e47b_bounded_calibration.py"
REGRESSIONS="$ROOT_DIR/ops/math_strategy_calibration/e47m_semantic_regressions.py"
PROTOCOL="$ROOT_DIR/paper/preregistration/e47m_equivalence_math_strategy_calibration.md"
ENDPOINT="$ROOT_DIR/var/artifacts/e49_math_strategy_qwen72_v1/qwen72_endpoint.json"
OUTPUT="$ROOT_DIR/var/artifacts/e47m_two_stage_math_strategy_calibration_v1"
LOG="$ROOT_DIR/var/artifacts/e47m_two_stage_math_strategy_calibration_v1.log"
...
if [[ ! -x "$PYTHON_BIN" ]] \
  ...
  echo "E47M frozen prerequisite is missing" >&2
  exit 2
fi
...
echo "=== E47M frozen proof/equivalence calibration ==="
...
echo "=== E47M automatic calibration complete; blinded audit ready ==="
