...
PROTOCOL="$ROOT_DIR/paper/preregistration/e47q_distinct_boundary_regression.md"
ENDPOINT="$ROOT_DIR/var/artifacts/e49_math_strategy_qwen72_v1/qwen72_endpoint.json"
OUTPUT_ROOT="$ROOT_DIR/var/artifacts/e47q_distinct_boundary_regression_v1"
LOG="$OUTPUT_ROOT.log"
...
echo "=== E47Q frozen distinct-boundary regression ==="
