...
SEEDS = (76631, 76632, 76633, 76634, 76635)
UPDATES = 96
...
BALANCED_V6_EVALUATION_FAMILIES = (
...
def main() -> None:
    ...
    balanced_v6 = (
        identity.get("schema")
        == "point-maze-balanced-v6-stage-b-05b-12pass-identity-v1"
    )
    geometry_shift = (
        identity.get("schema")
    ...
    submission_schema = (
        "point-maze-balanced-v6-stage-b-05b-12pass-submission-v1"
        if balanced_v6
        else (
    ...
    checks["qualification_pass"] = (
        (qualification_payload.get("schema_version") if balanced_v6 else qualification_payload.get("schema")) == qualification_schema
    ...
    payload = {
        "schema": (
            "point-maze-balanced-v6-stage-b-05b-12pass-audit-v1"
            if balanced_v6
            else (
        ...
        "decision": (
            "point_maze_balanced_v6_terminal_eligible"
            if balanced_v6 and not errors
            else (
                ...
                if geometry_shift and not errors
                    ...
                    if not errors
                        ...
                        "point_maze_balanced_v6_stage_b_stopped"
                        if balanced_v6
                        else (
