...
submit_domain() {
  ...
  case "$domain" in
    graph_coloring)
      ...
      export OAT_ZERO_TRAIN_NODELIST="${OAT_ZERO_E69_GRAPH_NODELIST:-node101}"
      export OAT_ZERO_TRAIN_GRES="${OAT_ZERO_E69_GRAPH_GRES:-gpu:a40:1}"
    ...
    countdown)
      ...
      export OAT_ZERO_TRAIN_NODELIST="${OAT_ZERO_E69_A5000_NODELIST:-node105}"
