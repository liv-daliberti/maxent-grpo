#!/usr/bin/env python3
"""Materialize the frozen Ant v15 slate with the admitted v17 controller."""
...
# This is an exact controller-only rebind of the frozen v15 slate. Geometry,
# routes, seeds, command limits, and action repeat are unchanged.
...
base.VERSION_LABEL = "ant-maze-v15-controller-v17-r1-data"
