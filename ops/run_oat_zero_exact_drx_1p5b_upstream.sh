...
export OAT_ZERO_WB_RUN_NAME="${OAT_ZERO_WB_RUN_NAME:-qwen2.5-Math-1.5b-r1-zero-readmeflash-exact-drx-signedbsem-noremix-tau025-noclipobj-${RUN_STAMP}}"
...
export OAT_ZERO_SEMANTIC_ENTROPY_LAMBDA="${OAT_ZERO_SEMANTIC_ENTROPY_LAMBDA:-0.05}"
