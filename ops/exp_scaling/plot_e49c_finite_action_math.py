#!/usr/bin/env python3
"""Render E49C's finite-action MATH quality and mechanism dashboard."""
...
LABELS = {
    ...
    "online_canonical_haarnoja": "E49C normalized canonical Haarnoja",
}
...
def main() -> None:
    ...
    output = args.out or (
        ROOT
        / "paper/figures"
        / f"e49c_finite_action_math_{args.stage}_live.png"
    )
    curve_path = (
        ROOT
        / "var/artifacts"
        / f"e49c_finite_action_math_{args.stage}_curve.json"
    )
    ...
    menu_summary = (
        ROOT
        / "var/artifacts"
        / f"e49c_math_strategy_menu_{args.stage}_v1/generation_summary.json"
    )
    menu_status = "pending"
    ...
    figure.suptitle(
        "E49C finite-action, execution-gated MATH — "
