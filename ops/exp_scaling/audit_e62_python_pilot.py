#!/usr/bin/env python3
"""Fail-closed live audit for E62-R9's same-seed Python mechanism pilot."""
...
IDENTITY = ROOT / "var/artifacts/e62r9_open_set_sweep_python_pilot_identity.json"
OUT = ROOT / "var/artifacts/e62r9_python_pilot_audit_latest.json"
PROTOCOL = (
    ROOT
...
PLOTTER = ROOT / "ops/exp_scaling/plot_e62_python_pilot.py"
WATCHER = ROOT / "ops/exp_scaling/watch_e62_python_pilot.sh"
PREFIX = "pye62r9_open_set_sweep_05b_1ep_pilot"
...
def audit(identity_path: Path) -> dict[str, Any]:
    ...
    if identity.get("schema") != "e62r9_open_set_sweep_python_pilot_v1":
    ...
    source_root = (
        ROOT
        / f"var/artifacts/source_snapshots/e62r9_open_set_sweep_{source_hash}/src"
    )
    ops_root = (
        ROOT
        / f"var/artifacts/source_snapshots/e62r9_open_set_sweep_ops_{ops_hash}/ops"
    )
    try:
