#!/usr/bin/env python3
"""Schedule the timeout-corrected frozen Ant v15/v17 admission launcher."""
...
v1.DEPENDENCY_BATCH = (
    ROOT
    / "ops/slurm/"
    "launch_ant_maze_v15_controller_v17_r2_after_controller.slurm"
)
v1.LAUNCHER = (
    ROOT
    / "ops/exp_scaling/"
    "launch_ant_maze_v15_controller_v17_r2_admission.py"
)
v1.MANIFEST = (
    ROOT
    / "var/artifacts/"
    "ant_maze_v15_controller_v17_r2_dependent_launcher_identity.json"
)
v1.FILES = (
    ROOT
