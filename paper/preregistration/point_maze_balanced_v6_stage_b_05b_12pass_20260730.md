# PointMaze balanced-v6 five-seed online comparison

**Status: FROZEN BEFORE THE V6 WARM-START QUALIFICATION OUTCOME OR ANY V6
...
reported. It launches only if the frozen orientation-balanced v6 warm-start
qualification passes.

## Cohort

- Shared checkpoint: exact `point_maze_interactive_warmstart_v6_balanced_short`.
...
- Arms: compute-matched Dr.GRPO and verified-first global replay-canonical
  MaxEnt.
- Seeds: 76631, 76632, 76633, 76634, and 76635, shared by arms.
