#!/usr/bin/env bash
# Submit paired 1.5B MaxEnt‑GRPO math runs (GRPO-only vs MaxEnt weighting) for 2000 steps.
...
declare -a RUN_NAMES=(
  "qwen25-1p5b-grpo-only-math-2k"
  "qwen25-1p5b-maxent-math-2k"
)
declare -a OUTPUT_DIRS=(
  "var/data/Qwen2.5-1.5B-Open-R1-GRPO-math-2k"
