"""Killable maze verifier process bound to the v17 worker entry point."""
...
class MazeVerifierProcessV17(MazeVerifierProcess):
    def _start(self) -> subprocess.Popen[str]:
        ...
        entrypoint = (
            ...
            "runpy.run_module("
            "'oat_drgrpo.maze_modebench_worker_v17',run_name='__main__')"
        )
