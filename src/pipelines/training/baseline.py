...
try:  # Expose a transformers handle for tests that monkeypatch logging.
    import transformers as transformers  # type: ignore
except ImportError:  # pragma: no cover - optional dependency
    transformers = ModuleType("transformers")  # type: ignore[assignment]
    ...
    utils_module.logging = tf_logging  # type: ignore[attr-defined]
    transformers.trainer_utils = trainer_utils  # type: ignore[attr-defined]
    transformers.utils = utils_module  # type: ignore[attr-defined]
...
if not hasattr(transformers, "set_seed"):
    transformers.set_seed = lambda *_args, **_kwargs: None  # type: ignore[attr-defined]
if not hasattr(transformers, "utils"):
    transformers.utils = SimpleNamespace(  # type: ignore[attr-defined]
