"""Reusable generation utilities shared across training modules."""
...
if TYPE_CHECKING:  # pragma: no cover - hints only
    ...
    from training.types import GenerationBatch, PromptCompletionBatch
...
def flatten_prompt_completions(
    ...
    :rtype: tuple[training.types.PromptCompletionBatch, list[str]]
    """
    from training.types import PromptCompletionBatch  # Local import to avoid cycles
