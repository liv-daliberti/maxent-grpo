...
if TYPE_CHECKING:
    ...
    try:
        ...
        HFPreTrainedModel = Any  # type: ignore[assignment]
        HFPreTrainedTokenizer = Any  # type: ignore[assignment]
