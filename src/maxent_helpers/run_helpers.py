...
def _prompt_char_limit_from_tokens(max_prompt_len: int) -> int:
    ...
    approx_char_limit = int(max_prompt_len * 4) if max_prompt_len and max_prompt_len > 0 else 0
...
@dataclass
class VLLMClientConfig:  # pylint: disable=too-many-instance-attributes
